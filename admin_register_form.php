...
<body>
 <form id="signup" method="POST" action="admin_register.php">
  <h1>Register to 404 Life not Found as an Admin!</h1>
  ...
  <?php if(isset($_SESSION["Error"]))
{
  ...
  <fieldset>
   ...
   <ol>						
    <li>
     ...
     <input id="password2" name="AdminP" type="password" title="Minimum 8 characters, one number, one uppercase and one lowercase letter" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*" required /> 
     <p class="validation01">
      <span class="invalid">Minimum 8 characters, one number, one uppercase letter and one lowercase letter</span>
  ...
  <center>
	...
	<form action="register.html" method="POST">	
		Register as a normal user?<input type="submit" href="register.html" value="Register!" />
	</form>
	</br>
	<form action="login.html" method="POST">	
		Already have an account?<input type="submit" href="login.html" value="Login" />
	</form>
	</br>
